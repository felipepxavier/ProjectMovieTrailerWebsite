...
2. Execute o arquivo "fresh_tomatoes.html" .

**Executando pelo IDLE**
1. Localize e execute o atalho "IDLE (Python GUI)";
2. Clique em "File", depois em "Open";
3. Localize e abra a pasta do projeto "Project_Movie_Trailer_Web";
4. Selecione o arquivo "entertainment_center.py" e clique em "Abrir";
5. Execute o arquivo pressionando o atalho "F5", ou na aba "Run" e "Run Module".

**Executando pelo Promp de Comando(Windows)**
1. Abra o Promp de Comando;
